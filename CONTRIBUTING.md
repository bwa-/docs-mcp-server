...
Use Node.js v24 for local development (for example, `nvm use 24`). If you switch Node versions after installing dependencies, run `npm rebuild` to recompile native modules.
