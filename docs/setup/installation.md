...
If you have Node.js 24.x installed (recommended for local development), you can run the server directly with a single command. Use `nvm use 24` and run `npm rebuild` if you recently changed Node versions:
